...
* *Architect products* suggests to evolve from designing cloud solutions to developing service assets. Architecting reusable assets is more efficient than designing blueprints for a specific solution and focusses teams on business value rather than applying generic cloud capabilites.
