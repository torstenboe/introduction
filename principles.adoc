...
* *Architect products* Evolve from cloud solutions to service assets. Architecting resusable assets is more efficient than designing blueprints for a specific solution and focusses teams on its customers.
